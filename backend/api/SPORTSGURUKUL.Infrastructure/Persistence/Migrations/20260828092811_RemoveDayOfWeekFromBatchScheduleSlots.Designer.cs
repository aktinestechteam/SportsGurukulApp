...
namespace SPORTSGURUKUL.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260828092811_RemoveDayOfWeekFromBatchScheduleSlots")]
    partial class RemoveDayOfWeekFromBatchScheduleSlots
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SPORTSGURUKUL.Domain.Entities.Batch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SPORTSGURUKUL.Domain.Entities.BatchAthlete", b =>
                {
                    ...
                    b.HasKey("BatchId", "AthleteId");

                    b.HasIndex("AthleteId")
                        .HasDatabaseName("IX_BatchAthletes_AthleteId");

                    b.ToTable("BatchAthletes", (string)null);
                });

            modelBuilder.Entity("SPORTSGURUKUL.Domain.Entities.BatchCoach", b =>
                {
                    b.Property<Guid>("BatchId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("BatchId", "CoachId");

                    b.HasIndex("CoachId")
                        .HasDatabaseName("IX_BatchCoaches_CoachId");

                    b.ToTable("BatchCoaches", (string)null);
                });

            modelBuilder.Entity("SPORTSGURUKUL.Domain.Entities.BatchScheduleSlot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("BatchScheduleSlots", (string)null);
                });
            ...
            modelBuilder.Entity("SPORTSGURUKUL.Domain.Entities.BatchAthlete", b =>
                {
                    ...
                    b.HasOne("SPORTSGURUKUL.Domain.Entities.Batch", "Batch")
                        .WithMany("AthleteAssociations")
