...
public class CreateAcademyAthleteCommandTests
{
    ...
    public async Task Create_AsOwner_SucceedsAndReturnsCreatedAthlete()
    {
        ...
        Assert.Equal("Cricket", response.Data.Sports[0].Name);
        Assert.Equal("Basketball", response.Data.Sports[1].Name);
    ...
    public async Task Create_AssignsAgeGroupAndSports()
    {
        ...
        Assert.Contains(createdAthlete.Sports, s => s.SportId == _sportId);
        Assert.Contains(createdAthlete.Sports, s => s.SportId == _secondarySportId);
        Assert.NotNull(response.Data);
    ...
    [Fact]
    public async Task Create_SportNotInAcademy_ThrowsValidationException()
    {
        var request = BuildRequest();
        request.SportIds = [Guid.NewGuid()];
        ...
        Assert.True(exception.Errors.ContainsKey("sportIds"));
    }

    [Fact]
    public async Task Create_DuplicateSports_ThrowsValidationException()
    {
        var request = BuildRequest();
        request.SportIds = [_sportId, _sportId];
    ...
    [Fact]
    public async Task Create_EmptySports_ThrowsValidationException()
    {
        var request = BuildRequest();
        request.SportIds = [];
    ...
    private CreateAthleteRequest BuildRequest()
        => new()
        {
            ...
            BranchId = _branchId,
            SportIds = [_sportId, _secondarySportId],
